...
//code is copied from https://gist.github.com/D-Nice/8de76f76dd60a29952264ab3898b9eb7
//we need this to calculate hash of ethereum address

//Optimized version working
...
contract SHA1 {
    ...
    function run(string _m) constant returns (bytes h) {
    ...
    function toBytes20(uint256 x) constant returns (bytes20 b) {
        assembly { 
            x
    ...
    function ROTL(uint x, uint y) internal returns (uint rotated) {
        assembly {
